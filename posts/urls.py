...
from .views import HomePageView, NotesDetailView, NotesCreateView, NotesUpdateView, NotesDeleteView, NotesSearchView, CommentCreateView, CommentDeleteView, CommentUpdateView
